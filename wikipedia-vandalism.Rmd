...
These two data points can be used as reference points in aReceiver Operating Characteristic Curve (ROC Curve). A ROC Curve, in principle, is similar to a PRC curve, but instead we plot the true positive rate against the false positive rate. Although @Potthast-2010 finds ROC curves not the most appropriate for comparing vandalism classifiers, it is the only visual comparison that we can do against the limited data available from ClueBot NG's performance.
...
pr_curves <- bind_rows(
  pr_curve(predictions, truth = "truth", knn) %>% add_column(model = "knn"),
  pr_curve(predictions, truth = "truth", knn_normalized) %>% add_column(model = "knn_normalized"),
  pr_curve(predictions, truth = "truth", knn_normalized_weigthed) %>% add_column(model = "knn_normalized_weigthed"),
  pr_curve(predictions, truth = "truth", nn) %>% add_column(model = "nn"),
  pr_curve(predictions, truth = "truth", rf_150) %>% add_column(model = "rf_150"),
  pr_curve(predictions, truth = "truth", rf_500) %>% add_column(model = "rf_500"),
  pr_curve(predictions, truth = "truth", rf_1000) %>% add_column(model = "rf_1000"),
  pr_curve(predictions, truth = "truth", random) %>% add_column(model = "random")
)
...
roc_curves <- bind_rows(
  roc_curve(predictions, truth = "truth", knn) %>% add_column(model = "knn"),
  roc_curve(predictions, truth = "truth", knn_normalized) %>% add_column(model = "knn_normalized"),
  roc_curve(predictions, truth = "truth", knn_normalized_weigthed) %>% add_column(model = "knn_normalized_weigthed"),
  roc_curve(predictions, truth = "truth", nn) %>% add_column(model = "nn"),
  roc_curve(predictions, truth = "truth", rf_150) %>% add_column(model = "rf_150"),
  roc_curve(predictions, truth = "truth", rf_500) %>% add_column(model = "rf_500"),
  roc_curve(predictions, truth = "truth", rf_1000) %>% add_column(model = "rf_1000"),
  roc_curve(predictions, truth = "truth", random) %>% add_column(model = "random")
)
...
```{r pr-auc, cache=TRUE}
pr_aocs <- bind_rows(
  pr_auc(predictions, truth = "truth", knn) %>% add_column(model = "knn"),
  pr_auc(predictions, truth = "truth", knn_normalized) %>% add_column(model = "knn_normalized"),
  pr_auc(predictions, truth = "truth", knn_normalized_weigthed) %>% add_column(model = "knn_normalized_weigthed"),
  pr_auc(predictions, truth = "truth", nn) %>% add_column(model = "nn"),
  pr_auc(predictions, truth = "truth", rf_150) %>% add_column(model = "rf_150"),
  pr_auc(predictions, truth = "truth", rf_500) %>% add_column(model = "rf_500"),
  pr_auc(predictions, truth = "truth", rf_1000) %>% add_column(model = "rf_1000"),
  pr_auc(predictions, truth = "truth", random) %>% add_column(model = "random")
)
...
```{r roc-auc, cache=TRUE}
roc_aocs <- bind_rows(
  roc_auc(predictions, truth = "truth", knn) %>% add_column(model = "knn"),
  roc_auc(predictions, truth = "truth", knn_normalized) %>% add_column(model = "knn_normalized"),
  roc_auc(predictions, truth = "truth", knn_normalized_weigthed) %>% add_column(model = "knn_normalized_weigthed"),
  roc_auc(predictions, truth = "truth", nn) %>% add_column(model = "nn"),
  roc_auc(predictions, truth = "truth", rf_150) %>% add_column(model = "rf_150"),
  roc_auc(predictions, truth = "truth", rf_500) %>% add_column(model = "rf_500"),
  roc_auc(predictions, truth = "truth", rf_1000) %>% add_column(model = "rf_1000"),
  roc_auc(predictions, truth = "truth", random) %>% add_column(model = "random")
)
